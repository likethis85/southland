    ...
    $.fn.treeview = function(settings) {
        var dfop =
            {
                ...
                onnodeclick: false,
                /**
	 	             * @description {Event} onnodehoverIn:function(tree, item)
	 	             * Fired when hover on a node.
	 	             * @param {Object} tree This tree object. 
	 	             * @param {Object} item Ndde item hovering.
	               */
                onnodehoverIn: false,
                /**
	 	             * @description {Event} onnodehoverOut:function(tree, item)
	 	             * Fired when hover on a node.
	 	             * @param {Object} tree This tree object. 
	 	             * @param {Object} item Ndde item hovering.
	               */
                onnodehoverOut: false,
                /**
        ...
        function bindevent() {
            $(this).hover(function() {
                ...
                if(item && dfop.onnodehoverIn) {
                    dfop.onnodehoverIn.call(this, item);
                }
            }, function() {
                $(this).removeClass("bbit-tree-node-over");
                var item = getItem($(this).attr("tpath"));
                if(item && dfop.onnodehoverOut) {
                    dfop.onnodehoverOut.call(this, item);
                }
            }).click(nodeclick)
